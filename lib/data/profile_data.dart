  ...
  static const Profile _englishProfile = Profile(
    ...
    projects: [
      Project(
        ...
        techStack: ['Android SDK', 'Kotlin', 'Jetpack Compose', 'Clean Architecture', 'Room DB', 'Retrofit', 'Coroutines', 'WorkManager'],
      ...
      Project(
        title: 'Retail CRM',
        period: '2021 – 2024',
        stackSummary: 'Kotlin · MVVM · Clean Architecture · Room · Retrofit · RxJava',
        techStack: ['Android SDK', 'Kotlin', 'MVVM', 'Clean Architecture', 'Room DB', 'Retrofit', 'RxJava', 'Coroutines'],
      ...
      Project(
        ...
        techStack: ['Flutter', 'Dart', 'Riverpod', 'Clean Architecture', 'REST APIs', 'Firebase', 'iOS & Android'],
      ...
      Project(
        ...
        techStack: ['Flutter', 'Dart', 'Riverpod', 'Firebase Push', 'REST APIs', 'Offline Sync', 'Cross-Platform'],
      ...
      Project(
        ...
        period: '2022 – 2024',
        stackSummary: 'Native Android · Kotlin · MVVM · Clean Architecture · Room · Retrofit · RxJava',
        techStack: ['Android SDK', 'Kotlin', 'MVVM', 'Clean Architecture', 'Room DB', 'Retrofit', 'RxJava', 'GPS Fleet Tracking'],
      ...
      Project(
        title: 'Buildistan',
        period: '2023 – Present',
        stackSummary: 'Flutter · Provider · Clean Architecture · REST APIs',
        techStack: ['Flutter', 'Dart', 'Provider', 'Clean Architecture', 'REST APIs', 'B2B Marketplace'],
      ...
      Project(
        title: 'Massage Club',
        period: '2017 – 2019',
        stackSummary: 'Android · Java · MVP · Retrofit · SQLite',
        techStack: ['Android SDK', 'Java', 'MVP', 'Retrofit', 'SQLite', 'REST APIs'],
