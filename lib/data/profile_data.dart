...
class ProfileData {
  ...
  static const String email = 'jayajitdutta7@gmail.com';
  ...
  static const List<Project> _verifiedProjects = [
    ...
    Project(
      ...
      overview:
          'Direct-to-consumer construction procurement application written in Flutter using Riverpod, featuring dynamic structural material estimators, milestone tracking, and direct order fulfillment.',
      myRole:
  ...
  static const Profile _englishProfile = Profile(
    ...
    education: [
      EducationItem(
        ...
        period: '2012 – 2015',
        detail: 'CGPA: 7.23 · First Class',
        degreeType: 'Post-Graduation Degree',
      ...
      EducationItem(
        ...
        degreeType: 'Professional Certification',
        location: 'Kolkata, West Bengal',
        coursework: [
          'Native Android SDK',
          'Java & Kotlin',
      ...
      EducationItem(
        ...
        period: '2006 – 2008',
        detail: 'Pure Science & Mathematics Stream',
      ...
      EducationItem(
        ...
        period: '2006',
        detail: 'WBBSE Board · General Secondary',
        degreeType: 'Secondary Schooling (10th)',
        location: 'Serampore, Hooghly, West Bengal',
        coursework: [
  ...
  static const Profile _bengaliProfile = Profile(
    ...
    education: [
      EducationItem(
        ...
        period: '২০১২ – ২০১৫',
        detail: 'CGPA: 7.23 · প্রথম শ্রেণি',
        degreeType: 'স্নাতকোত্তর ডিগ্রি',
      ...
      EducationItem(
        ...
        period: '২০০৮ – ২০১১',
        detail: 'CGPA: 7.21 · প্রথম শ্রেণি',
        degreeType: 'স্নাতক ডিগ্রি',
        location: 'কলকাতা, পশ্চিমবঙ্গ',
        coursework: [
          'সি / সি++ ও জাভা',
      ...
      EducationItem(
        title: 'প্রফেশনাল অ্যান্ড্রয়েড ডেভেলপার',
        institution: 'ইজব ইন্ডিয়া',
        period: '২০১৬ – ২০১৭',
        isCertification: true,
        degreeType: 'প্রফেশনাল সার্টিফিকেশন',
        location: 'কলকাতা, পশ্চিমবঙ্গ',
        coursework: [
          'নেটিভ অ্যান্ড্রয়েড এসডিকে',
          'জাভা ও কোটলিন',
          'এসকিউএললাইট',
          'রেস্ট এপিআই ও নেটওয়ার্কিং',
        ],
      ),
      EducationItem(
        title: 'উচ্চ মাধ্যমিক (দ্বাদশ শ্রেণি)',
        institution: 'শ্রীরামপুর হাই স্কুল',
        period: '২০০৬ – ২০০৮',
        detail: 'বিশুদ্ধ বিজ্ঞান ও গণিত শাখা',
        degreeType: 'উচ্চ মাধ্যমিক (১২তম)',
        location: 'শ্রীরামপুর, হুগলি, পশ্চিমবঙ্গ',
        coursework: [
          'বিশুদ্ধ বিজ্ঞান ও গণিত',
          'পদার্থবিজ্ঞান',
          'রসায়ন',
          'কম্পিউটার বিজ্ঞান',
          'ইংরেজি সাহিত্য',
      ...
      EducationItem(
        title: 'মাধ্যমিক (দশম শ্রেণি)',
        institution: 'শ্রীরামপুর ইউনিয়ন ইনস্টিটিউশন',
        period: '২০০৬',
        detail: 'WBBSE বোর্ড · মাধ্যমিক পাঠ্যক্রম',
        degreeType: 'মাধ্যমিক স্কুলিং (১০তম)',
        location: 'শ্রীরামপুর, হুগলি, পশ্চিমবঙ্গ',
        coursework: [
          'গণিত ও বিজ্ঞান',
          'ভৌত বিজ্ঞান',
  ...
  static const Profile _hindiProfile = Profile(
    ...
    education: [
      EducationItem(
        ...
        period: '2012 – 2015',
        detail: 'CGPA: 7.23 · प्रथम श्रेणी',
        degreeType: 'स्नातकोत्तर डिग्री',
      ...
      EducationItem(
        ...
        period: '2008 – 2011',
        detail: 'CGPA: 7.21 · प्रथम श्रेणी',
        degreeType: 'स्नातक डिग्री',
        location: 'कोलकाता, पश्चिम बंगाल',
        coursework: [
          'सी / सी++ और जावा',
      ...
      EducationItem(
        title: 'प्रोफेशनल एंड्रॉइड डेवलपर',
        institution: 'ईजॉब इंडिया',
        period: '2016 – 2017',
        isCertification: true,
        degreeType: 'प्रोफेशनल प्रमाणन',
        location: 'कोलकाता, पश्चिम बंगाल',
        coursework: [
          'नेटिव एंड्रॉइड एसडीके',
          'जावा और कोटलिन',
          'एसक्यूएललाइट',
          'रेस्ट एपीआई और नेटवर्किंग',
        ],
      ),
      EducationItem(
        title: 'उच्चतर माध्यमिक (12वीं)',
        institution: 'श्रीरामपुर हाई स्कूल',
        period: '2006 – 2008',
        detail: 'विशुद्ध विज्ञान एवं गणित संकाय',
        degreeType: 'उच्चतर माध्यमिक (12वीं)',
        location: 'श्रीरामपुर, हुगली, पश्चिम बंगाल',
        coursework: [
          'विशुद्ध विज्ञान और गणित',
          'भौतिकी',
          'रसायन विज्ञान',
          'कंप्यूटर विज्ञान',
          'अंग्रेजी',
      ...
      EducationItem(
        title: 'माध्यमिक (10वीं)',
        institution: 'श्रीरामपुर यूनियन इंस्टीट्यूशन',
        period: '2006',
        detail: 'WBBSE बोर्ड · सामान्य माध्यमिक',
        degreeType: 'माध्यमिक स्कूलिंग (10वीं)',
        location: 'श्रीरामपुर, हुगली, पश्चिम बंगाल',
        coursework: [
          'गणित और विज्ञान',
          'भौतिक विज्ञान',
