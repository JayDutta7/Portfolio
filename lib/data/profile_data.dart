...
class ProfileData {
  ...
  static const List<SkillCategory> skillCategories = [
    SkillCategory(
      title: 'Mobile',
      iconAsset: 'mobile',
      skills: ['Kotlin', 'Android', 'Flutter', 'Dart', 'Jetpack Compose'],
    ),
    SkillCategory(
      title: 'Architecture',
    ...
    SkillCategory(
      ...
      iconAsset: 'state',
      skills: ['Riverpod', 'Provider', 'StateFlow', 'SharedFlow'],
    ),
    SkillCategory(
      title: 'Networking',
      iconAsset: 'networking',
      skills: ['Dio', 'Retrofit', 'REST APIs', 'Postman'],
    ),
    SkillCategory(
      title: 'Storage',
      iconAsset: 'storage',
      skills: ['Room DB', 'SQLite', 'sqflite', 'ObjectBox'],
    ),
    SkillCategory(
      title: 'Specialized',
      iconAsset: 'other',
      skills: ['WorkManager', 'CameraX', 'ML Kit', 'OpenCV', 'Firebase'],
    ),
  ];
